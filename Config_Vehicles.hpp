class CarShops {
    ...
    */
    class civ_car {
        side = "civ";
        vehicles[] = {
            { "B_Quadbike_01_F", 3000, { "" }, { "", "", 1000 } },
            { "C_Hatchback_01_F", 9000, { "driver" }, { "", "", 3000 } },
            { "C_Offroad_01_F", 17500, { "driver" }, { "", "", 7000 } },
            { "C_SUV_01_F", 60000, { "driver" }, { "", "", 20000 } },
            { "C_Hatchback_01_sport_F", 30000, { "driver" }, { "", "", 10000 } },
            { "C_Van_01_transport_F", 40000, { "driver" }, { "", "", 15000 } }
        };
    };
    ...
    class kart_shop {
        side = "civ";
        vehicles[] = {
            { "C_Kart_01_Blu_F", 3000 , { "driver" }, { "", "", 1000 } },
            { "C_Kart_01_Fuel_F", 3000, { "driver" }, { "", "", 1000 } },
            { "C_Kart_01_Red_F", 3000, { "driver" }, { "", "", 1000 } },
            { "C_Kart_01_Vrana_F", 3000, { "driver" }, { "", "", 1000 } }
        };
    };
    ...
    class med_air_hs {
        side = "med";
        vehicles[] = {
            { "O_Heli_Light_02_unarmed_F", 50000, { "mAir" }, { "", "", -1 } }
        };
    };
    ...
    class cop_car {
        ...
        vehicles[] = {
            ...
            { "C_Hatchback_01_F", 7000, { "" }, { "life_coplevel", "SCALAR", 3 } },
			{ "C_SUV_01_F", 20000, { "" }, { "life_coplevel", "SCALAR", 6 } },
			{ "C_Hatchback_01_sport_F", 30000, { "" }, { "life_coplevel", "SCALAR", 4 } },
            { "B_MRAP_01_F", 50000, { "" }, { "life_coplevel", "SCALAR", 7 } },
            { "B_MRAP_01_hmg_F", 70000, { "" }, { "life_coplevel", "SCALAR", 8 } },
			{ "I_MRAP_03_F", 100000, { "" }, { "life_coplevel", "SCALAR", 8 } },
			{ "I_MRAP_03_hmg_F", 145000, { "" }, { "life_coplevel", "SCALAR", 8 } }
        };
    };
    ...
    class cop_air {
        side = "cop";
        vehicles[] = {
            { "B_Heli_Light_01_F", 200000, { "cAir" }, { "life_coplevel", "SCALAR", 3 } },
            { "I_Heli_light_03_unarmed_F", 200000, { "cAir" }, { "life_coplevel", "SCALAR", 5 } },
			{ "B_Heli_Transport_01_F", 200000, { "cAir" }, { "life_coplevel", "SCALAR", 8 } }
        };
    };
...
class LifeCfgVehicles {
    ...
    */
    ...
    class B_MRAP_01_hmg_F {
        ...
        textures[] = {
            { "Intervention", "cop", {
                "textures\PSIG_hunter.paa",
                "textures\PSIG_hunter2.jpg",
    ...
    class C_SUV_01_F {
        ...
        textures[] = {
			...
			{ "Médical", "med", {
                "textures\suv_samu.paa"
            } },
			{ "Craft", "civ", {
                "textures\civ_suv_craft.paa"
            } },
			{ "Monster", "civ", {
                "textures\civ_suv_monster.paa"
            } },
            { "Gendarmerie", "cop", {
                "textures\cop_suv.paa"
            } },
			{ "IGGN", "cop", {
                "textures\IGGN_suv.paa"
            } },
			{ "Banalisé", "cop", {
                "\a3\soft_f_gamma\SUV_01\Data\suv_01_ext_02_co.paa"
            } },
			{ "Douane", "cop", {
                "textures\DOUANE_suv.paa"
            } }
        };
    };
    ...
    class C_Van_01_box_F {
        ...
        textures[] = {
			...
			{ "Redgull", "civ", {
                "textures\van_redbull_back.paa",
				"textures\van_redbull_front.paa"
            } },
            { "Red", "civ", {
                "\a3\soft_f_gamma\Van_01\Data\van_01_ext_red_co.paa"
            } }
	...
	class I_Truck_02_box_F {
        ...
        textures[] = {
			{ "Pompier", "med", {
                "textures\cam_pompier.paa",
				"textures\cam_pompier2.paa"
            } }
		};
    };
};
